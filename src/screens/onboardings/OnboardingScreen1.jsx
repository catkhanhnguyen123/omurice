  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.middleContent}>
        ...
        <Image
          source={{ uri: 'https://i.ibb.co/j459h52/Presentation1-1-2.png' }}
          style={{ width: 280, height: 280, marginTop: 20, marginBottom: 40 }}
        />
        <Text style={styles.suggestText}>Recognize Accurately</Text>
        <Text style={styles.suggestSubText}>Detect and recognize your ingredients with an image of them.</Text>
      </View>
    </View>
  );
};
